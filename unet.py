...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.dec1_0 = nn.Conv2d(in_channels=64, out_channels=1, kernel_size=1, stride=1, padding=0, bias=True)
        ...
        # #팽창 단계
        # self.dec5_1 = CBR2d(in_channels=256, out_channels=256)
        # self.unpool4 = nn.ConvTranspose2d(in_channels=256, out_channels=128,
        #                         kernel_size=2, stride=2, padding=0, bias=True)

        # self.dec4_2 = CBR2d(in_channels=128 * 2, out_channels=128)
        # self.dec4_1 = CBR2d(in_channels=128, out_channels=128)
        # self.unpool3 = nn.ConvTranspose2d(in_channels=128, out_channels=64,
        #                         kernel_size=2, stride=2, padding=0, bias=True)
        
        # self.dec3_2 = CBR2d(in_channels=64 * 2, out_channels=64)
        # self.dec3_1 = CBR2d(in_channels=64, out_channels=64)
        # self.unpool2 = nn.ConvTranspose2d(in_channels=64, out_channels=32,
        #                         kernel_size=2, stride=2, padding=0, bias=True)

        # self.dec2_2 = CBR2d(in_channels=32 * 2, out_channels=32)
        # self.dec2_1 = CBR2d(in_channels=32, out_channels=32)
        # self.unpool1 = nn.ConvTranspose2d(in_channels=32, out_channels=16,
        #                         kernel_size=2, stride=2, padding=0, bias=True)

        # self.dec1_2 = CBR2d(in_channels=16 * 2, out_channels=16)
        # self.dec1_1 = CBR2d(in_channels=16, out_channels=16)
        # self.dec1_0 = nn.Conv2d(in_channels=16, out_channels=1, kernel_size=1, stride=1, padding=0, bias=True)
